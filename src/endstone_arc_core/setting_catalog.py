...
SETTING_GROUPS: List[Dict[str, object]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            _s("FIXED_DEPOSIT_RATE_1M", "[全服] 定期存款月利率-1个月（%）", "float", placeholder="5"),
            _s("FIXED_DEPOSIT_RATE_3M", "[全服] 定期存款月利率-3个月（%）", "float", placeholder="5"),
            _s("FIXED_DEPOSIT_RATE_6M", "[全服] 定期存款月利率-6个月（%）", "float", placeholder="5"),
            _s("FIXED_DEPOSIT_RATE_12M", "[全服] 定期存款月利率-12个月（%）", "float", placeholder="5"),
